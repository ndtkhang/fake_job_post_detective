...
// -------------------------------------------------------
// Parser (server-safe, lazy OpenAI client)
// -------------------------------------------------------
...
Your only job is to read a job description and extract structured fields
that match the Kaggle "Real or Fake Job Posting Prediction" dataset.
...

{
  ...
  "telecommuting": 0 or 1 or null,
  "has_company_logo": 0 or 1 or null,
  "has_questions": 0 or 1 or null,
